function [Err, Err_indx, cnt, MSE, W1, W2, time] = DSGT_28_38(InputData, InputLabel, W1, W2,...
         Attributes0, Classifications0, nbrOfEpochs, alpha0, e0, n, W)
     
    fprintf('Starting DSGT_28_38.\n');
    tic;
    ...
    for m = 1 : m_max
        ...
        [W1, W2, W1_prev, W2_prev, gW1_prev, gW2_prev] = SGupdate_DSGT_28_38(W1, W2, gW1, gW2, W1_prev, W2_prev, gW1_prev, gW2_prev, n, W, alpha);
    ...
    time = toc;
    fprintf('DSGT_28_38 done, and the running time is %d s.\n', time);
