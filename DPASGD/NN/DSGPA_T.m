function [Err, Err_indx, cnt, MSE, W1, W2, time] = DSGPA_T(InputData, InputLabel, W1, W2, V1, V2, ...
         Attributes0, Classifications0, nbrOfEpochs, alpha0, beta0, eta0, e0, n, L)
     
    fprintf('Starting DSGPA_T.\n');
    tic;
%     m_max = nbrOfEpochs*e0(1); % max number of iterations
    ...
    for m = 1:m_max
        ...
        %~~~~~~~~~~ Modify paramters here to make it time varing ~~~~~~~~~~
        ...
        [W1, W2 , V1, V2] = SGupdate_DSGPA(W1, W2, V1, V2, gW1, gW2, n, L, alpha, beta, eta);
    ...
    time = toc;
    fprintf('DSGPA_T done, and the running time is %d s.\n', time);
end