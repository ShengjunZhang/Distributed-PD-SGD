function [Err, Err_indx, cnt, MSE, W1, W2, time] = DSGT_29_37(InputData, InputLabel, W1, W2,...
         Attributes0, Classifications0, nbrOfEpochs, alpha0, e0, n, W)
     
    fprintf('Starting DSGT_29_37.\n');
    tic;
    ...
    for i = 1:n
        W1_prev{i} = W1_prev_prev{i} - alpha*gW1_prev{i};
        W2_prev{i} = W2_prev_prev{i} - alpha*gW2_prev{i};
    end
    ...
    for m = 1 : m_max
        ...
        [W1, W2, W1_prev, W2_prev, gW1_prev, gW2_prev] = SGupdate_DSGT_29_37(W1, W2, gW1, gW2, W1_prev, W2_prev, gW1_prev, gW2_prev, n, W, alpha);
    ...
    time = toc;
    fprintf('DSGT_29_37 done, and the running time is %d s.\n', time);
