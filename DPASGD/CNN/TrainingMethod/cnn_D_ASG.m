function [opttheta, cost_e, time] = cnn_D_ASG(funObj, cnn_distributed, training, Graph, n_agents, options)
...
for e = 1:epochs
    ...
    for s = 1:minibatch:(m-minibatch+1)
            ...
            it = it + 1;
            theta_matrix_prev = theta_matrix;
            for i = 1:n_agents
            ...
            theta_matrix = Graph*y - alpha*grad_matrix;
            y = (1+beta)*theta_matrix - beta*theta_matrix_prev;
...
time = toc;
fprintf('D-ASG done, and the running time is %d s.\n', time);
end
