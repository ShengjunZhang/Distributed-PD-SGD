function [opttheta, cost_e, time] = cnn_DSGT_28_38(funObj, cnn_distributed, training, Graph, n_agents, options)
...
cost_e = [];
it = 0;
fprintf('Starting DSGT in [28][38].\n');
tic;
...
time = toc;
fprintf('DSGT in [28][38] done, and the running time is %d s.\n', time);
end
