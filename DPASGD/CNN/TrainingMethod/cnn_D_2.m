function [opttheta, cost_e, time] = cnn_D_2(funObj, cnn_distributed, training, Graph, n_agents, options)
...
for e = 1:epochs
    ...
    for s = 1:minibatch:(m-minibatch+1)
            ...
            gamma = gamma0/(10 + sqrt(it));
            
            theta_matrix = theta_matrix - gamma*y;
            y = y + grad_matrix - grad_prev;
